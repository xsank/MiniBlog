...
DATABASES = {
    'default': {
        ...
        'NAME': 'MiniBlog',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'wzdn%t3cf!32+n6j9y&!_4q#go1yb@pzya6=#b3j8iie=)#@2@'
...
MIDDLEWARE_CLASSES = (
    'MiniBlog.blog.helptool.SetRemoteAddrFromForwardedFor',
...
TEMPLATE_DIRS = ('E:/django_test/MiniBlog/templates',)
...
AKISMET_API_KEY = '46fe4734a97f'

CACHE_BACKEND='db://testcache'
...
GRAPPELLI_ADMIN_TITLE='Xsank BackGroud'
...
GRAPPELLI_INDEX_DASHBOARD = 'MiniBlog.dashboard.CustomIndexDashboard'